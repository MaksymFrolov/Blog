...
// export default class CommentService {
//     static getCommentsByPostId = mem(async (id: number, page: number, limit: number): Promise<AxiosResponse<IComment[]>> => {
//         return axios.get(`/api/posts/${id}/comments`, { params: { page, limit } })
//     },
//         {
//             maxAge,
//         }
//     )
//     static getCommentsByUserId = mem(async (id: number, page?: number, limit?: number): Promise<AxiosResponse<IComment[]>> => {
//         return axios.get(`/api/people/${id}/comments`, { params: { page, limit } })
//     },
//         {
//             maxAge,
